...
static void kafl_guest_setup_bitmap(kafl_mem_state *s, uint32_t bitmap_size){
	...
	reterrfd = open(s->reterr_file, O_CREAT|O_RDWR, S_IRWXU|S_IRWXG|S_IRWXO);
	...
	reterrp = mmap(0, 1, PROT_READ|PROT_WRITE, MAP_SHARED, reterrfd, 0);
...
static Property kafl_guest_properties[] = {
	...
	DEFINE_PROP_STRING("reterr", kafl_mem_state, reterr_file),
