...
class DataFlowAnalysis {
	...
	public:
		...
		void findEqualUses(Value *start, set<Value *> TrackedSet, set<Value *> &UseSet);
	...
	public:
		//BasicBlock backward data flow maps
		std::map<BasicBlock *, list<BasicBlock *>> BBBDFMaps;
		std::map<Value *, set<Value *>> VBDMaps;
};
